...
// //       <Navbar />
// //       <div className="mt-28  mx-auto  sm:px-6 bg-slate-600">
// //         <div className="flex flex-col md:flex-row justify-between items-center -mx-4">
// //           <div className="md:flex-1 px-4 text-center md:text-left bg-red-400">
...
// //             </button>
// //           </div>
// //           <div className="md:flex-1 mt-4 md:mt-0 bg-black">
...
//       <div className="mt-28 mx-auto sm:px-6 bg-slate-600">
//         <div className="flex flex-col md:flex-row justify-between items-center -mx-4">
//           <div className="md:flex-1 px-4 text-center md:text-left bg-red-400 mb-8 md:mb-0">
//             <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mb-5">
//               <span className="text-[#FAAD13]">Design Theory:</span>
//               <br />
//               The Psychology of <br />
...
const BookDetails = () => {
  return (
    <main className='mx-6 lg:mx-36'>
      <div className='flex flex-col md:flex-row justify-center md:justify-between bg '>
        <div className=' bg-red-300 h-1/2 w-1/2'>ww</div>
        <div className=' bg-red-500 h-1/2 w-1/2'>ww</div>
      </div>
    </main>
